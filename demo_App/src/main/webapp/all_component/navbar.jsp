...
<div class="container-fulid" style="height:10px; background-color:#303f9f">
...
<div class="col-md-3">
<a href="cart.jsp"><i class="fa-solid fa-cart-plus "></i> Cart</a><br>
<a href="login.jsp" class="btn btn-success "><i class="fa-sharp fa-solid fa-user-plus"></i> ${userobj.name}</a>
...
<a href="register.jsp" class="btn btn-primary text-white"><i class="fa-sharp fa-solid fa-user-plus"></i>  Register</a>
</div>
</c:if>
</div>
</div>
